...
def write_supply_adjustment(
    ...
    with open(filepath, "w") as f:
        ...
        f.write("C\n")
        f.write(
            "C   NCOLADJ:  Number of columns in the supply "
            "adjustment specifications data\n"
        )
        f.write(
            "C   NSPADJ :  Number of time steps to update the "
            "supply adjustment specifications\n"
        )
        f.write(
            "C   NFQADJ :  Repetition frequency of the supply "
            "adjustment specifications data\n"
        )
        f.write(
            "C   DSSFL  :  DSS filename (blank = inline data)\n"
        )
        f.write("C\n")
        f.write(
            "C------------------------------------------------------"
        ...
        f.write(
            f"          {data.n_columns:<38}/ NCOLADJ\n"
        )
        f.write(
            f"          {data.nsp:<38}/ NSPADJ\n"
        )
        f.write(
            f"          {data.nfq:<38}/ NFQADJ\n"
        )
        ...
        f.write(
            "C   KADJ :  Supply adjustment code (2-digit: "
            "1st=ag, 2nd=urban)\n"
        )
