...
"""
    ...
    def write_nodes(self) -> Path:
        ...
        with open(output_path, "w") as f:
            ...
            f.write("C\n")
            f.write(f"C                         Generated by pyiwfm\n")
    ...
    def write_elements(self) -> Path:
        ...
        unique_sr_ids = sorted(set(
            getattr(grid.elements[eid], "subregion", 1) or 1
        ...
        if subregions:
            sr_names = [subregions.get(sr_id, type('obj', (object,), {'name': f"Region_{sr_id}"})()).name
        ...
        with open(output_path, "w") as f:
            ...
            for elem_id in sorted_elem_ids:
                ...
                f.write(f"{elem_id:6d} {vertices[0]:6d} {vertices[1]:6d} "
    ...
    def write_stream_config(self) -> Path:
        ...
        with open(output_path, "w") as f:
            ...
            if streams is None:
                ...
                f.write(f"{n_stream_nodes}                                            / NSTRMNODE\n")
                f.write("C\n")
